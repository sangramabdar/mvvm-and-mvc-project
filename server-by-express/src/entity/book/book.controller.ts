...
interface BookController extends EntityController<BookEntity> {}

class BookControllerImpl
  extends EntityControllerImpl<BookEntity, BookService>
  implements BookController
{
  static BookController: BookController = new BookControllerImpl();
  constructor() {
    super();
    this.entityService = new BookServiceImpl();
  }
}
export { BookController, BookControllerImpl };
